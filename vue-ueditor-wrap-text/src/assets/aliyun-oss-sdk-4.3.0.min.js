  ...
  })(
    {
                ...
                function(o) {
                  for (;;)
                    switch ((o.prev = o.next)) {
                      case 0:
                        return (
                          (n = this._bucketRequestParams('PUT', e, '', r)),
                          t &&
                            ((n.mime = 'xml'),
                            (n.content =
                      ...
                      case 5:
                        return (
                          ...
                          o.abrupt('return', {
                            bucket:
                              (i.headers.location &&
                                i.headers.location.substring(1)) ||
                              null,
                            res: i.res
                          })
                        )
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (n = this._bucketRequestParams('DELETE', e, '', r)),
                          t.delegateYield(this.request(n), 't0', 2)
                        )
                      case 2:
                        if (
                          ((i = t.t0), 200 !== i.status && 204 !== i.status)
                        ) {
                          t.next = 5
                          break
                        }
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (i = this._bucketRequestParams('PUT', e, 'acl', n)),
                          (i.headers = { 'x-oss-acl': r }),
                      ...
                      case 5:
                        return (
                          ...
                          t.abrupt('return', {
                            bucket:
                              (a.headers.location &&
                                a.headers.location.substring(1)) ||
                              null,
                            res: a.res
                          })
                        )
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (n = this._bucketRequestParams('GET', e, 'acl', r)),
                          (n.successStatuses = [200]),
                          (n.xmlResponse = !0),
                      ...
                      case 4:
                        return (
                          ...
                          t.abrupt('return', {
                            ...
                            error:
                              (i.data.ErrorDocument &&
                                i.data.ErrorDocument.Key) ||
                              null,
                            res: i.res
                          })
                        )
                        ...
                        return (
                          ...
                          a &&
                            ...
                            (a = a.map(function(e) {
                              ...
                              return (
                                e.Expiration.Days
                                  ? (t.days = e.Expiration.Days)
                                  : (t.date = e.Expiration.Date),
                                t
                              )
                            }))),
                    ...
                    switch ((n.prev = n.next)) {
                      case 0:
                        return n.delegateYield(
                          this.putBucketReferer(e, t, !0, null, r),
                          't0',
                          1
                        )
                      case 1:
          ...
          ;(function(r, n) {
            ...
            function o(t) {
              ...
              if (
                ...
                (this.options.timeout = g(this.options.timeout)),
              ...
              this.options.urllib
                ...
                : ((this.urllib = e('urllib')),
                  (this.agent = this.options.agent || new y()))
            }
            function a(e, t) {
            ...
            b(k, e('./object')),
              ...
              (k.authorization = function(e, t, r, n) {
                ...
                for (var s in n) {
                  ...
                  0 === c.indexOf('x-oss-') &&
                    ((o[c] = o[c] || []), o[c].push(String(n[s]).trim()))
                }
                var u = []
                ;(0, l['default'])(o)
                  .sort()
              ...
              (k.createRequest = function(e) {
                ...
                this.options.stsToken &&
                  (r['x-oss-security-token'] = this.options.stsToken),
                  d(e.headers).to(r),
                  a(r, 'Content-Type') ||
                    (e.mime === m.default_type && (e.mime = ''),
                    e.mime && e.mime.indexOf('/') > 0
                      ? (r['Content-Type'] = e.mime)
                      : (r['Content-Type'] = m.lookup(
                          e.mime || h.extname(e.object)
                        ))),
                  e.content &&
                    ((r['Content-Md5'] = f
                      .createHash('md5')
                      .update(new n(e.content, 'utf8'))
                      .digest('base64')),
                    r['Content-Length'] ||
                      (r['Content-Length'] = e.content.length))
                      ...
                      switch ((i.prev = i.next)) {
                        ...
                        case 3:
                          if (
                            ...
                            !e.successStatuses ||
                              -1 !== e.successStatuses.indexOf(r.status))
                          ) {
                            i.next = 10
                            break
                          }
              ...
              (k.parseXML = function(e) {
                return function(t) {
                  n.isBuffer(e) && (e = e.toString()),
                    v.parseString(e, { explicitRoot: !1, explicitArray: !1 }, t)
                }
              }),
                    ...
                    for (;;)
                      switch ((i.prev = i.next)) {
                        case 0:
                          ...
                          404 === e.status
                            ? ((t = new Error('Object not exists')),
                              (t.name = 'NoSuchKeyError'),
                              (t.status = 404),
                              (t.code = 'NoSuchKey'))
                            : 412 === e.status
                            ? ((t = new Error('Pre condition failed')),
                              (t.name = 'PreconditionFailedError'),
                              (t.status = 412),
                              (t.code = 'PreconditionFailed'))
                            : ((t = new Error(
                        ...
                        case 29:
                          return (
                            p('generate error %j', t), i.abrupt('return', t)
                          )
                        case 31:
                        case 'end':
                          return i.stop()
            ...
            t.exports = function(e) {
              function t(r) {
                ...
                ;(this._checkAvailableLock = !1),
                  (this._timerId = s.setInterval(
                    this._checkAvailable.bind(this),
                    o
                  )),
                  this._init()
              }
              ...
              return (
                      ...
                      function(t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 18:
                              return (
                                (t.prev = 18), (t.next = 21), s[e].apply(n, r)
                              )
                            case 21:
                              return t.abrupt('return', t.sent)
                            case 24:
                    ...
                    function(o) {
                      for (;;)
                        switch ((o.prev = o.next)) {
                          case 0:
                            if (
                              ((t = '._ali-oss/check.status.' + h + '.txt'), !e)
                            ) {
                              o.next = 4
                              break
                            }
                            return (
                              ...
                              this.put(
                                t,
                                new r('check available started at ' + Date())
                              )
                            )
                          case 4:
                    ...
                    function(n) {
                      for (;;)
                        switch ((n.prev = n.next)) {
                          case 0:
                            return (
                              (r = !0), (n.prev = 1), (n.next = 4), e.head(t)
                            )
                          case 4:
                            n.next = 9
                            break
                ...
                (n._nextRRIndex = function() {
                  var e = this.index++
                  return (
                    this.index >= this.clients.length && (this.index = 0), e
                  )
                }),
                (n.close = function() {
      ...
      5: [
        function(e, t, r) {
          ...
          t.exports = function(e) {
            ...
            return (
              (t.prototype.get = a['default'].mark(function r(e, t, n) {
                  ...
                  function(i) {
                    for (;;)
                      switch ((i.prev = i.next)) {
                        case 0:
                          return (
                            (r = this.ossClient._objectRequestParams(
                              'GET',
                              e + '@exif',
                              t
                            )),
                        ...
                        case 3:
                          return (
                            (n = i.t0), (i.next = 6), this._parseResponse(n)
                          )
                        case 6:
                          return (
                            (n = i.sent),
                            i.abrupt('return', { res: n.res, data: n.data })
                          )
                        case 8:
                        case 'end':
                          return i.stop()
                  ...
                  function(o) {
                    for (;;)
                      switch ((o.prev = o.next)) {
                        case 0:
                          return (
                            (n = this.ossClient._objectRequestParams(
                              'PUT',
                              '/?style&styleName=' + e,
                              r
                            )),
                        ...
                        case 4:
                          return (
                            (i = o.t0), (o.next = 7), this._parseResponse(i)
                          )
                        case 7:
                          return (
                            (i = o.sent),
                            o.abrupt('return', { res: i.res, data: i.data })
                          )
                        case 9:
                        case 'end':
                          return o.stop()
                  ...
                  function(n) {
                    for (;;)
                      switch ((n.prev = n.next)) {
                        case 0:
                          return (
                            (t = this.ossClient._objectRequestParams(
                              'GET',
                              '/?style',
                              e
                            )),
                        ...
                        case 3:
                          return (
                            (r = n.t0), (n.next = 6), this._parseResponse(r)
                          )
                        case 6:
                          return (
                            (r = n.sent),
              ...
              (t.prototype.signatureUrl = function(e) {
                return this.ossClient.signatureUrl(
                  e,
                  this.ossClient.options.imageHost
                )
              }),
          ...
          ;(function(t) {
            ...
            function i(e, t) {
              return this instanceof i
                ? (h.call(this, t), (this.file = e), void (this.reader = null))
                : new i(e, t)
            }
            var o = e('babel-runtime/regenerator'),
              a = n(o),
            ...
            ;(f.multipartUpload = a['default'].mark(function d(e, t, r) {
                  ...
                  for (;;)
                    switch ((a.prev = a.next)) {
                      case 0:
                        ...
                        return (
                          (a.next = 4), this._resumeMultipart(r.checkpoint, r)
                        )
                      case 4:
                      ...
                      case 23:
                        ...
                        throw new Error(
                          'partSize must not be smaller than ' + n
                        )
                      case 25:
                    ...
                    for (;;)
                      switch ((a.prev = a.next)) {
                        ...
                        case 14:
                          if (
                            ((d = a.sent),
                            s.push({ number: h, etag: d.res.headers.etag }),
                            (e.nextPart = f + 1),
                            !t || !t.progress)
                          ) {
                            a.next = 20
                  ...
                  function(o) {
                    for (;;)
                      switch ((o.prev = o.next)) {
                        ...
                        case 6:
                          return (
                            (i = o.sent), o.abrupt('return', { res: i.res })
                          )
                        case 8:
                        case 'end':
                          return o.stop()
                    ...
                    for (;;)
                      switch ((a.prev = a.next)) {
                        case 0:
                          return (
                            (i = {}),
                            (i.headers = { 'Content-Length': n.size }),
                            (i.subres = { partNumber: r, uploadId: t }),
              ...
              (f._completeMultipartUpload = a['default'].mark(function _(
                e,
                t,
                r,
                n
                        ...
                        case 0:
                          for (
                            ...
                            (s = r[o]),
                              (i += '<Part>\n'),
                              (i +=
                                '<PartNumber>' + s.number + '</PartNumber>\n'),
                              (i += '<ETag>' + s.etag + '</ETag>\n'),
                              (i += '</Part>\n')
                          return (
                            (i += '</CompleteMultipartUpload>'),
                            (n = n || {}),
                            (n.subres = { uploadId: t }),
            ...
            u.inherits(i, h),
              ...
              (f._createStream = function(e, t, r) {
                ...
                if (c.string(e))
                  return s.createReadStream(e, { start: t, end: r - 1 })
        ...
        function(e, t, r) {
          ...
          ;(d.put = o['default'].mark(function m(e, t, r) {
                ...
                for (;;)
                  switch ((o.prev = o.next)) {
                    ...
                    case 5:
                      ...
                      return (
                        (r.mime = r.mime || h.lookup(f.extname(t))),
                    ...
                    switch ((o.prev = o.next)) {
                      case 0:
                        return (
                          ...
                          (r.headers = r.headers || {}),
                          r.contentLength
                            ? (r.headers['Content-Length'] = r.contentLength)
                ...
                function(o) {
                  for (;;)
                    switch ((o.prev = o.next)) {
                      case 0:
                        return (
                          (r = this._objectRequestParams('HEAD', e, t)),
                      ...
                      case 4:
                        if (
                          ((n = o.sent),
                          (i = { meta: null, res: n.res, status: n.status }),
                          200 === n.status)
                        )
                          for (a in n.headers)
                            0 === a.indexOf('x-oss-meta-') &&
                              (i.meta || (i.meta = {}),
                              (i.meta[a.substring(11)] = n.headers[a]))
                ...
                function(i) {
                  for (;;)
                    switch ((i.prev = i.next)) {
                      case 0:
                        return (
                          (r = this._objectRequestParams('DELETE', e, t)),
                          (r.successStatuses = [204]),
                          (i.next = 4),
                          this.request(r)
                        )
                  ...
                  for (;;)
                    switch ((o.prev = o.next)) {
                      case 0:
                        ...
                        for (n in r.headers)
                          r.headers['x-oss-copy-source-' + n.toLowerCase()] =
                            r.headers[n]
                        return (
                          r.meta &&
                            (r.headers['x-oss-metadata-directive'] = 'REPLACE'),
                          this._convertMetaToHeaders(r.meta, r.headers),
                          '/' !== t[0] &&
                            (t = '/' + this.options.bucket + '/' + t),
            ...
            (d.signatureUrl = function(e, t) {
              ...
              this.options.stsToken &&
                ((o['security-token'] = this.options.stsToken),
                a.push('security-token=' + this.options.stsToken)),
        ...
        function(e, t, r) {
          ...
          function i(t) {
            ...
            ;(this.options = {
              ...
              this.options.urllib
                ? (this.urllib = this.options.urllib)
                : ((this.urllib = e('urllib')),
                  (this.agent = this.options.agent || new m()))
          }
          ...
          ;(y.assumeRole = c['default'].mark(function b(e, t, r, n, i) {
                ...
                for (;;)
                  switch ((c.prev = c.next)) {
                    ...
                    case 8:
                      ...
                      (c.t0 = c['catch'](4)),
                      new Error(
                        'Policy string is not a valid JSON: ' + c.t0.message
                      ))
                    case 11:
                      c.next = 14
                      break
                    ...
                    case 15:
                      return (
                        (u = this._getSignature('POST', a, o.accessKeySecret)),
                        (a.Signature = u),
                        (f = o.endpoint),
                        (d = {
                          agent: this.agent,
            ...
            (y._getSignature = function(e, t, r) {
              ...
              return (
                (s = s.update(o).digest('base64')), p('signature: %s', s), s
              )
            }),
        ...
        function(e, t, r) {
          ...
          n.mac = function(e, t) {
            ...
            return r
              ? r.mac
                ? t(null, r.mac)
                : void s.exec(l, { timeout: 5e3 }, function(n, o, a) {
                    if (n || !o) return t(n)
          ...
          ;(n.dns = function(e, t) {
            'function' == typeof e && ((t = e), (e = null)),
              (e = e || c),
              a.readFile(e, 'utf8', function(e, r) {
                if (e) return t(e)
                var n = []
                r = r || ''
                for (var i = r.split('\n'), o = 0; o < i.length; o++) {
        ...
        function(e, t, r) {
          ...
          function n(e) {
            ...
            ;(t.defaultPort = 80),
              ...
              t.on('free', function(e, r) {
                var n = t.getName(r)
                if (
                  (c('agent.on(free)', n),
                  !e.destroyed && t.requests[n] && t.requests[n].length)
                )
                  t.requests[n].shift().onSocket(e),
                  ...
                  if (
                    ...
                    t.sockets[n] && (u += t.sockets[n].length),
                      u > t.maxSockets || s >= t.maxFreeSockets
                        ? (t.removeSocket(e, r), e.destroy())
                        : ((a = a || []),
                          (t.freeSockets[n] = a),
                          e.setKeepAlive(!0, t.keepAliveMsecs),
                          e.unref && e.unref(),
                          (e._httpMessage = null),
                          t.removeSocket(e, r),
                          a.push(e),
                          0 === e.listeners('error').length &&
                            e.once('error', i),
                          e.setTimeout(t.keepAliveTimeout))
          ...
          a.inherits(n, s),
            ...
            (n.prototype.addRequest = function(e, t) {
              'string' == typeof t &&
                (t = { host: t, port: arguments[2], path: arguments[3] }),
                (t = a._extend({}, t)),
              ...
              if (n) {
                ...
                o < this.maxSockets
                  ? (c('call onSocket', o, n),
                    e.onSocket(this.createSocket(e, t)))
                  : (c('wait for socket'),
                    this.requests[r] || (this.requests[r] = []),
                    this.requests[r].push(e))
            }),
            (n.prototype.createSocket = function(e, t) {
              ...
              if (
                ((t = a._extend({}, t)),
                (t = a._extend(t, s.options)),
                !t.servername && ((t.servername = t.host), e))
              ) {
            ...
            (n.prototype.removeSocket = function(e, t) {
              ...
              for (var a = 0; a < o.length; a++) {
                ...
                if (s[i]) {
                  var u = s[i].indexOf(e)
                  ;-1 !== u &&
                    (s[i].splice(u, 1), 0 === s[i].length && delete s[i])
                }
              }
              if (
                ((r = this.freeSockets[i] ? this.freeSockets[i].length : 0),
                (n = r + this.sockets[i] ? this.sockets[i].length : 0),
                this.requests[i] &&
                  this.requests[i].length &&
                  n < this.maxSockets)
              ) {
            ...
            (n.prototype.destroy = function() {
              for (
                var e = [this.freeSockets, this.sockets], t = 0;
                t < e.length;
                t++
              )
        ...
        function(e, t, r) {
          ...
          ;(t.exports = n),
            ...
            (n.prototype.createSocket = function(e, t) {
              ...
              return (
                this.keepAlive && r.setNoDelay(!0), this.createSocketCount++, r
              )
            }),
        ...
        function(e, t, r) {
          ...
          o.isNode10
            ? ((n = function(e) {
              ...
              o.inherits(n, a),
              (n.prototype.createConnection = i.globalAgent.createConnection),
              (n.prototype.getName = function(e) {
        ...
        function(e, t, r) {
          ;(function(t) {
            ...
            ;(n = o
              ? function() {
                  t.env.NODE_DEBUG &&
                    /agentkeepalive/.test(t.env.NODE_DEBUG) &&
        ...
        function(e, t, r) {
          ...
          t.exports = function(e, t, r, y, b, _, x) {
            ...
            if (
              ...
              if (
                ((w = { values: j ? R : k(v), keys: _ ? R : k(m), entries: C }),
                x)
              )
                for (E in w) E in A || o(A, E, w[E])
      ...
      69: [
        function(e, t, r) {
          ...
          if (p)
            ...
            new c(f).observe(d, { characterData: !0 }),
              (o = function() {
                d.data = h = !h
              })
          } else
        ...
        function(e, t, r) {
            ...
            u = function() {
              ...
              for (
                r.style.display = 'none',
                  ...
                  t.open(),
                  t.write('<script>document.F=Object</script' + i),
                  t.close(),
                  u = t.F;
                n--;
          ...
          t.exports =
            ...
            function(e, t) {
              ...
              return (
                null !== e
                  ? ((s[c] = n(e)), (r = new s()), (s[c] = null), (r[a] = e))
                  : (r = u()),
                void 0 === t ? r : i(r, t)
              )
            }
      ...
      72: [
        function(e, t, r) {
          ...
          t.exports = e('./_descriptors')
            ...
            : function(e, t) {
                i(e)
                for (var r, a = o(t), s = a.length, c = 0; s > c; )
                  n.f(e, (r = a[c++]), t[r])
                return e
              }
        },
      ...
      110: [
        function(e, t, r) {
          ...
          var n = e('./_global'),
            ...
            X = function(e, t) {
              y(e)
              for (var r, n = v((t = b(t))), i = 0, o = n.length; o > i; )
                Y(e, (r = n[i++]), t[r])
              return e
            },
            K = function(e, t) {
            ...
            V = function(e) {
              ...
              return t || !o(this, e) || !o(q, e) || (o(this, P) && this[P][e])
                ? t
                : !0
            },
            W = function(e, t) {
              ...
              return (
                !r || !o(q, t) || (o(e, P) && e[P][t]) || (r.enumerable = !0), r
              )
            },
            $ = function(e) {
          ...
          F ||
            ...
            (S.f = W),
            (k.f = Y),
            (e('./_object-gopn').f = E.f = $),
            (e('./_object-pie').f = V),
            (e('./_object-gops').f = J),
            a && !e('./_library') && c(U, 'propertyIsEnumerable', V, !0)),
          ...
          ;(B && B[N] && B[N].findChild) || (C = !0),
            ...
            I && s(s.S + s.F * (!F || Z), 'JSON', { stringify: Q }),
      ...
      112: [
        function(e, t, r) {
          ;(function(r) {
            ...
            if (
              ((n.regeneratorRuntime = void 0), (t.exports = e('./runtime')), i)
            )
          ...
          ;(function(r, n) {
            ...
            !(function(e) {
              ...
              function m(e) {
                function t(t, r) {
                  ...
                  return i instanceof h
                    ? a['default'].resolve(i.arg).then(o, s)
                    : a['default'].resolve(i).then(function(e) {
                        return (n.value = e), n
                      })
                }
                function n(e, r) {
              ...
              function g(e, t, r) {
                ...
                return function(o, a) {
                  ...
                  for (;;) {
                    ...
                    if ('next' === o)
                      (r._sent = a), n === A ? (r.sent = a) : (r.sent = E)
                    else if ('throw' === o) {
                      if (n === O) throw ((n = R), a)
              ...
              var E,
                ...
                k =
                  ('function' == typeof v['default'] && d['default']) ||
                  '@@iterator',
                T =
                  'object' ===
                  ('undefined' == typeof t
              ...
              ;(s.prototype = N.constructor = u),
                ...
                (j.mark = function(e) {
                  return (
                    c['default'] ? (0, c['default'])(e, u) : (e.__proto__ = u),
                ...
                (_.prototype = {
                  ...
                  finish: function(e) {
                    for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                      ...
                      if (r.finallyLoc === e)
                        return this.complete(r.completion, r.afterLoc), b(r), C
                    }
                  },
                  catch: function(e) {
                    for (var t = this.tryEntries.length - 1; t >= 0; --t) {
      ...
      116: [
        function(e, t, r) {
          ;(function(t) {
            ...
            function a(e, t) {
              if (((e = m(e, 0 > t ? 0 : 0 | v(t))), !o.TYPED_ARRAY_SUPPORT))
            ...
            function D(e, t, r, n) {
              0 > t && (t = 65535 + t + 1)
              for (var i = 0, o = Math.min(e.length - r, 2); o > i; i++)
                e[r + i] =
                  (t & (255 << (8 * (n ? i : 1 - i)))) >>> (8 * (n ? i : 1 - i))
            }
            function M(e, t, r, n) {
              0 > t && (t = 4294967295 + t + 1)
              for (var i = 0, o = Math.min(e.length - r, 4); o > i; i++)
        ...
        function(e, t, r) {
          ...
          function i(e) {
            ...
            return (
              2 === o
                ? ((i =
                    (u[e.charCodeAt(t)] << 2) | (u[e.charCodeAt(t + 1)] >> 4)),
                  (a[c++] = 255 & i))
                : 1 === o &&
                  ((i =
                    (u[e.charCodeAt(t)] << 10) |
            ...
            !(function(i) {
              ...
              function h(e) {
                var t,
                  ...
                  y = A,
                  b = O
                for (r = e.lastIndexOf(I), 0 > r && (r = 0), n = 0; r > n; ++n)
                ...
                for (i = r > 0 ? r + 1 : 0; v > i; ) {
                  for (
                    ...
                    i >= v && o('invalid-input'),
                      (p = l(e.charCodeAt(i++))),
                      (p >= E || p > M((w - g) / s)) && o('overflow'),
                      (g += p * s),
                      (h = b >= c ? S : c >= b + k ? k : c - b),
                      !(h > p);
                    c += E
                  )
                    (d = E - h), s > M(w / d) && o('overflow'), (s *= d)
                  ;(t = m.length + 1),
                    (b = f(g - a, t, 0 == a)),
              ...
              function d(e) {
                var t,
                  ...
                  _ = []
                for (
                  e = c(e), v = e.length, t = A, r = 0, a = O, s = 0;
                  v > s;
                  ++s
                )
                ...
                for (n = i = _.length, i && _.push(I); v > n; ) {
                  ...
                  for (
                    ...
                    if (
                      ((m = e[s]), t > m && ++r > w && o('overflow'), m == t)
                    ) {
                      for (
                        l = r, h = E;
                        (d = a >= h ? S : h >= a + k ? k : h - a), !(d > l);
                        h += E
                      )
                        (b = l - d),
                          (y = E - d),
              ...
              'object' == typeof e
                ? n(a(e), function(a) {
                    ...
                    return o(e[a])
                      ...
                      : s + encodeURIComponent(i(e[a]))
                  }).join(t)
                : s
                ? encodeURIComponent(i(s)) + r + encodeURIComponent(i(e))
                : ''
            )
          }
          var o =
          ...
          ;(function(r) {
            ...
            function n(t, r) {
              ...
              ;(this.highWaterMark = n || 0 === n ? n : i),
                ...
                (this.encoding = null),
                t.encoding &&
                  (N || (N = e('string_decoder/').StringDecoder),
                  (this.decoder = new N(t.encoding)),
            ...
            function d(e, t) {
              for (
                ...
                (C('maybeReadMore read 0'), e.read(0), r !== t.length);
            ...
            function _(e, t) {
              ...
              if (0 === i) r = null
                ...
                (r = o ? n.join('') : 1 === n.length ? n[0] : j.concat(n, i)),
                  (n.length = 0)
            ...
            ;(i.prototype.read = function(e) {
              ...
              C('need readable', n),
                (0 === t.length || t.length - e < t.highWaterMark) &&
                  ((n = !0), C('length less than watermark', n)),
              ...
              (i.prototype.pipe = function(e, t) {
                ...
                var h =
                    (!t || t.end !== !1) && e !== r.stdout && e !== r.stderr,
                  d = h ? i : o
              ...
              (i.prototype.on = function(e, t) {
                ...
                if (
                  ...
                  n.readableListening ||
                    ...
                    (n.emittedReadable = !1),
                    (n.needReadable = !0),
                    n.reading ? n.length && p(this, n) : k(v, this))
                }
                return r
              }),
              ...
              (i.prototype.resume = function() {
                ...
                return (
                  e.flowing || (C('resume'), (e.flowing = !0), g(this, e)), this
                )
              }),
      ...
      137: [
        function(e, t, r) {
          ...
          function a(t) {
            return (
              (A = A || e('./_stream_duplex')),
              this instanceof a || this instanceof A
          ...
          function _(e, t) {
            ...
            return (
              r &&
                (0 === t.pendingcb
                  ? (b(e, t), (t.finished = !0), e.emit('finish'))
                  : b(e, t)),
              r
            )
          }
          ...
          ;(function(e) {
            ...
            ;(r.arraybuffer = a && t('arraybuffer')),
              ...
              (r.mozchunkedarraybuffer =
                !r.fetch && a && t('moz-chunked-arraybuffer')),
          ...
          ;(function(r, n, i) {
              ...
              d = (t.exports = function(e) {
                ...
                l.Writable.call(t),
                  ...
                  e.auth &&
                    t.setHeader(
                      'Authorization',
                      'Basic ' + new i(e.auth).toString('base64')
                    ),
            ...
            c(d, l.Writable),
              ...
              (d.prototype._onFinish = function() {
                ...
                if (!e._destroyed) {
                  ...
                  if (
                    ...
                    'responseType' in u &&
                      (u.responseType = e._mode.split(':')[0]),
              ...
              (d.prototype._connect = function() {
                var e = this
                e._destroyed ||
                  ((e._response = new f(e._xhr, e._fetchResponse, e._mode)),
            ...
            var o = e('./capability'),
              ...
              u = (r.IncomingMessage = function(e, r, n) {
                ...
                if (
                  ...
                  for (
                    var u, l, p = r.headers[Symbol.iterator]();
                    (u = (l = p.next()).value), !l.done;

                  )
                    (c.headers[u[0].toLowerCase()] = u[1]),
              ...
              (u.prototype._onXHRProgress = function() {
                ...
                switch (e._mode) {
                  ...
                  case 'moz-chunked-arraybuffer':
                    if (((r = t.response), t.readyState !== c.LOADING || !r))
                      break
                  ...
                  case 'ms-stream':
                    ...
                    ;(l.onprogress = function() {
                      l.result.byteLength > e._pos &&
                        (e.push(new i(new Uint8Array(l.result.slice(e._pos)))),
        ...
        function(e, t, r) {
          ...
          ;(n.prototype.parse = function(e, t, r) {
              ...
              if (p)
                return (
                  ...
                  p[2]
                    ? ((this.search = p[2]),
                      t
                        ? (this.query = S.parse(this.search.substr(1)))
            ...
            if (!w[h] && (k || (h && !E[h]))) {
              ...
              if (!R)
                for (
                  var C = this.hostname.split(/\./), j = 0, N = C.length;
                  N > j;
                  j++
                ) {
                  var P = C[j]
                  if (P && !P.match(b)) {
                    for (var D = '', M = 0, L = P.length; L > M; M++)
                      D += P.charCodeAt(M) > 127 ? 'x' : P[M]
                    if (!D.match(b)) {
                      var q = C.slice(0, j),
                        U = C.slice(j + 1),
                        F = P.match(_)
            ...
            if (
              (-1 !== X
                ...
                : t && ((this.search = ''), (this.query = {})),
              s && (this.pathname = s),
              E[d] && this.hostname && !this.pathname && (this.pathname = '/'),
        ...
        function(e, t, r) {
          ;(function(t, n) {
            ...
            function c(e, t, n) {
              ...
              if (
                (w(t) && (g = ' ' + RegExp.prototype.toString.call(t)),
                S(t) && (g = ' ' + Date.prototype.toUTCString.call(t)),
                k(t) && (g = ' ' + l(t)),
              ...
              if (
                ...
                s ||
                  (e.seen.indexOf(u.value) < 0
                    ? ((s = v(r) ? c(e, u.value, null) : c(e, u.value, r - 1)),
                      s.indexOf('\n') > -1 &&
                        (s = o
                          ? s
                              .split('\n')
            ...
            ;(r.format = function(e) {
              ...
              for (
                var r = 1,
                  n = arguments,
                  o = n.length,
                  a = String(e).replace(C, function(e) {
                    if ('%%' === e) return '%'
                    if (r >= o) return e
                    switch (e) {
                      case '%s':
      ...
      161: [
        function(e, t, r) {
          ...
          function o(e) {
            ...
            return new Promise(function(r, n) {
              e.call(t, function(e, t) {
                return e
                  ? n(e)
                  : (arguments.length > 2 && (t = f.call(arguments, 1)),
                    void r(t))
              })
            })
          }
          ...
          function s(e) {
            ...
            for (
              var r = new e.constructor(), n = Object.keys(e), o = [], a = 0;
              a < n.length;
              a++
            ) {
              var s = n[a],
      ...
      162: [
        function(e, t, r) {
          ...
          function n(e, t) {
            return this instanceof n
              ? ((this.src = e), void (this._withAccess = t))
              : new n(e, t)
          }
          function i(e, t) {
            return (
              void 0 === e[t] &&
              void 0 === e.__lookupGetter__(t) &&
              void 0 === e.__lookupSetter__(t)
            )
          }
          ...
          ;(t.exports = n),
            ...
            (n.prototype.pick = function(e) {
              return (
                Array.isArray(e) || (e = o.call(arguments)),
            ...
            (n.prototype.toCover = function(e) {
              for (
                var t = this.keys || Object.keys(this.src), r = 0;
                r < t.length;
                r++
              ) {
                var n = t[r]
            ...
            (n.prototype.and = function(e) {
              var t = {}
              return (
                this.to(t), (this.src = e), this.to(t), (this.src = t), this
              )
            })
        },
        {}
      ...
      163: [
        function(e, t, r) {
          function n(e, t) {
            ...
            for (
              var n = [], i = t ? e.readInt32BE : e.readInt32LE, o = 0;
              o < e.length;
              o += s
            )
              n.push(i.call(e, o))
          ...
          function i(e, t, r) {
            for (
              var n = new a(t), i = r ? n.writeInt32BE : n.writeInt32LE, o = 0;
              o < e.length;
              o++
            )
              i.call(n, e[o], 4 * o, !0)
        ...
        function(e, t, r) {
          function n(e, t, r) {
            s.isBuffer(t) || (t = new s(t)),
              ...
              t.length > h
                ? (t = e(t))
                : t.length < h && (t = s.concat([t, d], h))
            for (var n = new s(h), i = new s(h), o = 0; h > o; o++)
          ...
          function i(e, t) {
            ...
            var r = f[e],
              ...
              a = 0
            return (
              r || o('algorithm:', e, 'is not yet supported'),
              {
                update: function(e) {
                  return (
          ...
          function n(e, t) {
            ...
            for (
              ...
              for (var h = n, d = c, m = u, v = l, g = p, y = 0; 80 > y; y++) {
                16 > y
                  ? (r[y] = e[f + y])
                  : (r[y] = s(r[y - 3] ^ r[y - 8] ^ r[y - 14] ^ r[y - 16], 1))
        ...
        function(e, t, r) {
          ...
          function n(e) {
            return e instanceof a
              ? i(e)
              : e instanceof s
              ? ('function' == typeof e.destroy && e.destroy(), e)
              : e
          }
          function i(e) {
            return (
              e.destroy(), 'function' == typeof e.close && e.on('open', o), e
            )
          }
          function o() {
                ...
                0 === arguments.length
                  ? new Promise(
                      function(e) {
                        return this._ready
                          ? e()
                          : void this._readyCallbacks.push(e)
                      }.bind(this)
                    )
                  : ('function' == typeof t
        ...
        function(e, t, r) {
          ;(function(r) {
            ...
            t.exports = function(e) {
              ...
              return (
                void 0 === t &&
                  console.warn('ms(%j) got undefined in %s', e, r),
                t
              )
            }
        ...
        function(e, t, r) {
          ...
          Object.keys(i).map(function(e) {
            ...
            (r.generatorFunction = function(e) {
              return (
                e && e.constructor && 'GeneratorFunction' === e.constructor.name
              )
            }),
      ...
      178: [
        function(e, t, r) {
          ;(function(e) {
            ...
            isBuffer: e(
              '../../../../browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js'
            )
          }))
        },
        {
        ...
        function(t, r, n) {
          !(function(t) {
            ...
            function o(e) {
              return (
                'function' == typeof e &&
                (/^class\s/.test(a.call(e)) || /^.*classCallCheck\(/.test(i(e)))
              )
            }
            var a = Function.prototype.toString
            'undefined' != typeof n
              ? ('undefined' != typeof r && r.exports && (n = r.exports = o),
                (n.isClass = o))
            ...
            ;(function() {
              ...
              function d(e) {
                ...
                if (
                  (K && (K = [K]),
                  $ && !W && (W = a([$])),
                  (k = /\bGoogle TV\b/.exec(W)) && (W = k[0]),
                  /\bSimulator\b/i.test(e) &&
                    (W = (W ? W + ' ' : '') + 'Simulator'),
                  'Opera Mini' == V &&
                    /\bOPiOS\b/.test(e) &&
                    z.push('running in Turbo/Uncompressed mode'),
                  /^iP/.test(W)
                    ? (V || (V = 'Safari'),
                      (J =
                        'iOS' +
                    ...
                    ? $ &&
                      ...
                      : (V &&
                          !(k =
                            !/\bMinefield\b|\(Android;/i.test(e) &&
                            /\b(?:Firefox|Safari)\b/.exec(V))) ||
                        (V &&
                          !W &&
                          /[\/,]|^[^(]+?\)/.test(
                            e.slice(e.indexOf(k + '/') + 8)
                          ) &&
                          (V = null),
                        (k = W || $ || J) &&
                          (W ||
                          ...
                          (V =
                            /[a-z]+(?: Hat)?/i.exec(
                              /\bAndroid\b/.test(J) ? J : k
                            ) + ' Browser'))
                    : (J = 'Kubuntu'),
                  (k = /\((Mobile|Tablet).*?Firefox\b/i.exec(e)) &&
                    k[1] &&
                    ((J = 'Firefox OS'), W || (W = k[1])),
                  X ||
                    (X = m([
                  ...
                  'iCab' == K && parseFloat(X) > 3
                    ? (K = ['WebKit'])
                    : 'Trident' != K &&
                      (k =
                        (/\bOpera\b/.test(V) &&
                          (/\bOPR\b/.test(e) ? 'Blink' : 'Presto')) ||
                        (/\b(?:Midori|Nook|Safari)\b/i.test(e) && 'WebKit') ||
                        (!K &&
                          /\bMSIE\b/i.test(e) &&
                    ...
                    : /\bPlayStation\b(?! Vita\b)/i.test(V) &&
                      ...
                      (K = ['NetFront']),
                  'IE' == V &&
                  (k = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(e) || 0)[1])
                    ? ((V += ' Mobile'),
                      (J = 'Windows Phone ' + (/\+$/.test(k) ? k : k + '.x')),
                      z.unshift('desktop mode'))
                    : /\bWPDesktop\b/i.test(e)
                    ? ((V = 'IE Mobile'),
                      (J = 'Windows Phone 8+'),
                      z.unshift('desktop mode'),
                      X || (X = (/\brv:([\d.]+)/.exec(e) || 0)[1]))
                    : 'IE' != V &&
                      'Trident' == K &&
                      (k = /\brv:([\d.]+)/.exec(e))
                    ? (/\bWPDesktop\b/i.test(e) ||
                        (V &&
                          z.push('identifying as ' + V + (X ? ' ' + X : '')),
                        (V = 'IE')),
                      (X = k[1]))
                    : ('Chrome' != V && 'IE' == V) ||
                      !(k = /\bEdge\/([\d.]+)/.exec(e)) ||
                      ((V = 'Microsoft Edge'), (X = k[1]), (K = ['Trident'])),
                  Y)
                ) {
                  if (l(b, 'global'))
                    if (
                      (D &&
                        ((k = D.lang.System),
                        (G = k.getProperty('os.arch')),
                        (J =
                          J ||
                          k.getProperty('os.name') +
                            ' ' +
                            k.getProperty('os.version'))),
                      O && l(b, 'system') && (k = [b.system])[0])
                    ) {
                      J || (J = k[0].os || null)
                      try {
                      ...
                      'object' == typeof b.process && (k = b.process)
                        ? ((V = 'Node.js'),
                          (G = k.arch),
                          (J = k.platform),
                          (X = /[\d.]+/.exec(k.version)[0]))
                        : M && (V = 'Rhino')
                  else
                    u((k = b.runtime)) == R
                      ? ((V = 'Adobe AIR'),
                        (J = k.flash.system.Capabilities.os))
                      : u((k = b.phantom)) == P
                      ? ((V = 'PhantomJS'),
                        (X =
                          (k = k.version || null) &&
                      ...
                      : 'number' == typeof U.documentMode &&
                        (k = /\bTrident\/(\d+)/i.exec(e)) &&
                        ((X = [X, U.documentMode]),
                        (k = +k[1] + 4) != X[1] &&
                          (z.push('IE ' + X[1] + ' mode'),
                          K && (K[1] = ''),
                          (X[1] = k)),
                        (X = 'IE' == V ? String(X[1].toFixed(1)) : X[0]))
                  J = J && s(J)
                }
                X &&
                  (k =
                    ...
                    /(?:alpha|beta)(?: ?\d)?/i.exec(
                      e + ';' + (Y && x.appMinorVersion)
                    ) ||
                    (/\bMinefield\b/i.test(e) && 'a')) &&
                  ((H = /b/i.test(k) ? 'beta' : 'alpha'),
                  (X =
                    X.replace(RegExp(k + '\\+?$'), '') +
                    ('beta' == H ? q : L) +
                    (/\d+\+?/.exec(k) || ''))),
                  'Fennec' == V ||
                  ('Firefox' == V && /\b(?:Android|Firefox OS)\b/.test(J))
                    ? (V = 'Firefox Mobile')
                    : 'Maxthon' == V && X
                    ? (X = X.replace(/\.[\d.]+/, '.x'))
                    : 'Silk' == V
                    ? (/\bMobi/i.test(e) ||
                        ((J = 'Android'), z.unshift('desktop mode')),
                      /Accelerated *= *true/i.test(e) &&
                        z.unshift('accelerated'))
                    : /\bXbox\b/i.test(W)
                    ? ((J = null),
                      'Xbox 360' == W &&
                        /\bIEMobile\b/.test(e) &&
                        z.unshift('mobile mode'))
                    : (!/^(?:Chrome|IE|Opera)$/.test(V) &&
                        (!V || W || /Browser|Mobi/.test(V))) ||
                      ('Windows CE' != J && !/Mobi/i.test(e))
                    ? 'IE' == V && Y && null === b.external
                      ...
                      : this != c &&
                        ...
                        ((Y && F) ||
                          ...
                          ('Firefox' == V && /\bOS X (?:\d+\.){2,}/.test(J)) ||
                          ('IE' == V &&
                            ((J && !/^Win/.test(J) && X > 5.5) ||
                              (/\bWindows XP\b/.test(J) && X > 8) ||
                              (8 == X && !/\bTrident\b/.test(e))))) &&
                        !w.test((k = d.call(c, e.replace(w, '') + ';'))) &&
                        k.name &&
                        ((k =
                          'ing as ' +
                          k.name +
                          ((k = k.version) ? ' ' + k : '')),
                        w.test(V)
                          ? (/\bIE\b/.test(k) && 'Mac OS' == J && (J = null),
                            (k = 'identify' + k))
                          : ((k = 'mask' + k),
                            (V = B
                              ? s(B.replace(/([a-z])([A-Z])/g, '$1 $2'))
                              : 'Opera'),
                            /\bIE\b/.test(k) && (J = null),
                            Y || (X = null)),
                        (K = ['Presto']),
                        z.push(k))
                    : (V += ' Mobile'),
                  (k = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(e) || 0)[1]) &&
                    ((k = [parseFloat(k.replace(/\.(\d)$/, '.0$1')), k]),
                    'Safari' == V && '+' == k[1].slice(-1)
                      ? ((V = 'WebKit Nightly'),
                        (H = 'alpha'),
                        (X = k[1].slice(0, -1)))
                      : (X != k[1] &&
                          X !=
                            (k[2] = (/\bSafari\/([\d.]+\+?)/i.exec(e) ||
                              0)[1])) ||
                        (X = null),
                    (k[1] = (/\bChrome\/([\d.]+)/i.exec(e) || 0)[1]),
                    537.36 == k[0] &&
                      537.36 == k[2] &&
                      parseFloat(k[1]) >= 28 &&
                      'IE' != V &&
                      ...
                      (K[1] +=
                        ...
                        (k +=
                          'number' == typeof k
                            ...
                            ? ''
                            : '+')),
                    'Safari' == V && (!X || parseInt(X) > 45) && (X = k)),
                  'Opera' == V && (k = /\bzbov|zvav$/.exec(J))
                    ? ((V += ' '),
                      z.unshift('desktop mode'),
                      'zvav' == k
                        ? ((V += 'Mini'), (X = null))
                        : (V += 'Mobile'),
                      (J = J.replace(RegExp(' *' + k + '$'), '')))
                    : 'Safari' == V &&
                  ...
                  J &&
                    ((k = / ([\d.+]+)$/.exec(J)),
                    (j = k && '/' == J.charAt(J.length - k[0].length - 1)),
                    (J = {
                      architecture: 32,
                  ...
                  (k = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(G)) &&
                    !/\bi686\b/i.test(G) &&
                    (J &&
                      ((J.architecture = 64),
                      (J.family = J.family.replace(RegExp(' *' + k), ''))),
                    V &&
                      (/\bWOW64\b/i.test(e) ||
                        (Y &&
              ...
              !_ ||
                (_.global !== _ && _.window !== _ && _.self !== _) ||
                (v = _)
      ...
      186: [
        function(e, t, r) {
          ;(function(t, n) {
            ...
            function o(e) {
              return (
                R[e] || '\\u' + (e.charCodeAt(0) + 65536).toString(16).substr(1)
              )
            }
            function a(e) {
            ...
            function s(e, t) {
              ...
              try {
                ...
                'SyntaxError' === n.name &&
                  (n.name = 'JSONResponseFormatError'),
                  e.length > 1024
                    ? (n.message +=
                        ' (data json format: ' +
                        JSON.stringify(e.slice(0, 512)) +
                        ' ...skip... ' +
                        JSON.stringify(e.slice(e.length - 512)) +
                        ')')
                    : (n.message +=
                        ' (data json format: ' + JSON.stringify(e) + ')'),
                  (r.error = n)
              }
              return r
            }
            function c(e) {
              w.call(this),
                (e = e || {}),
                e.agent
                  ? ((this.agent = e.agent), (this.hasCustomAgent = !0))
                  : ((this.agent = r.agent), (this.hasCustomAgent = !1)),
                e.httpsAgent
                  ? ((this.httpsAgent = e.httpsAgent),
                    (this.hasCustomHttpsAgent = !0))
                  : ((this.httpsAgent = r.httpsAgent),
                    (this.hasCustomHttpsAgent = !1))
            }
            function u(e, t) {
            ...
            ;(r.request = function(t, n, o) {
              ...
              (r.requestWithCallback = function(i, o, a) {
                ...
                var c = ++j
                o.emitter &&
                  o.emitter.emit('request', { requestId: c, url: i, args: o }),
                ...
                R.rejectUnauthorized !== !1 ||
                  R.hasOwnProperty('secureOptions') ||
                  (R.secureOptions = e('constants').SSL_OP_NO_TLSv1_2)
                var D = o.auth || l.auth
                D && (R.auth = D)
                var M = o.content || o.data,
                  L = 'GET' === y || 'HEAD' === y
                if (!o.content && M && 'string' != typeof M && !n.isBuffer(M))
                  if (L) M = v.stringify(M)
                  else {
                    var q =
                ...
                var B = null,
                  ...
                  K = function(e, n, s) {
                    if ((B && (clearTimeout(B), (B = null)), !a))
                      return (
                        console.warn(
                          '[urllib:warn] [%s] [worker:%s] %s %s callback twice!!!',
                          Date(),
                          t.pid,
                          R.method,
                          i
                    ...
                    var l = -1,
                      h = {}
                    if (
                      (s && ((l = s.statusCode), (h = s.headers)),
                      401 === l &&
                        h['www-authenticate'] &&
                        (!o.headers || !o.headers.Authorization) &&
                        o.digestAuth)
                    ) {
                      var d = h['www-authenticate']
                      if (d.indexOf('Digest ') >= 0)
                        return (
                          f(
                          ...
                          s.headers['set-cookie'] &&
                            (o.headers.Cookie = s.headers['set-cookie'].join(
                              ';'
                            )),
                    ...
                    if (e) {
                      var g = ''
                      w &&
                        'function' == typeof w.getCurrentStatus &&
                        (g =
                          ', agent status: ' +
                          JSON.stringify(w.getCurrentStatus())),
                        (e.message +=
                          ', ' +
                          R.method +
                          ' ' +
                ...
                var W = function(e, t, r) {
                    ...
                    return 0 === t.length
                      ? r(null, t, n)
                      : n && 'gzip' === n.toLowerCase()
                      ? (f('gunzip %d length body', t.length),
                        void g.gunzip(t, r))
                      : r(null, t, n)
                  },
                  $ = o.writeStream
                ...
                var J = x.request(R, function(e) {
                    ...
                    if ($) {
                      ...
                      return t.redirect
                        ? void e.resume()
                        : t.error
                        ? (e.resume(), $.end(), K(t.error, null, e))
                        : ($.on('close', K.bind(null, null, null, e)),
                          e.pipe($))
                    }
                    var r = []
                              ...
                              W(e, t, function(r, n, a) {
                                ...
                                if (!a && A.indexOf(o.dataType) >= 0) {
                                  try {
                                    ...
                                    return (
                                      f('decodeBodyByCharset error: %s', l),
                                      K(null, n, e)
                                    )
                                  }
                                  if ('json' === o.dataType)
                ...
                return (
                  (B = setTimeout(function() {
                    ...
                    J.socket ||
                      ...
                      (e += ', working sockets is full')),
                      (G = new Error(e)),
                      (G.name = t),
                      (G.requestId = c),
                      f(
                        'Request#%d %s %s: %s, connected: %s',
                        c,
                        i,
                        G.name,
                        e,
                  ...
                  J.once('socket', function(e) {
                    return 'opening' === e.readyState
                      ? void e.once('connect', function() {
                          f('Request#%d %s new socket connected', c, i),
                            (z = !0)
                        })
                      : (f('Request#%d %s reuse socket connected', c, i),
                        (z = !0),
                        void (H = !0))
                  }),
                  J.on('error', function(e) {
                    'Error' === e.name &&
                      (e.name = z ? 'ResponseError' : 'RequestError'),
                      (e.message += ' (req "error")'),
                      f(
                  ...
                  o.stream
                    ? (o.stream.pipe(J),
                      o.stream.once('error', function(e) {
      ...
      190: [
        function(e, t, r) {
          ...
          t.exports = function(e, t) {
            if (!e && t)
              throw new Error(
                "You can't specify a `release` without specfying `platform`"
              )
      ...
      191: [
        function(e, t, r) {
          ...
          t.exports = function(e) {
            return (
              (e = (e || n.release()).split('.')[0]),
              { name: i[e], version: '10.' + (Number(e) - 4) }
            )
          }
        },
        { os: 125 }
          ...
          ;(function(r) {
            ...
            t.exports = function(t) {
              ...
              if (
                !t &&
                'win32' === r.platform &&
                i.satisfies(r.version, '>=0.12.0 <3.1.0')
              )
                try {
                  s = a.exec(
                    String(
                      e('child_process').execSync('ver.exe', { timeout: 2e3 })
                    )
                  )
                } catch (c) {}
              if (t && !s)
        ...
        function(e, t, r) {
          ;(function(e) {
            ...
            function a(e, t) {
              ...
              if (e.length > K)
                throw new TypeError(
                  'version is longer than ' + K + ' characters'
                )
            ...
            function U(e, t) {
              ...
              if (t.prerelease.length) {
                for (var r = 0; r < e.length; r++)
                  if (
                    (X(e[r].semver),
                    e[r].semver !== Ue && e[r].semver.prerelease.length > 0)
                  ) {
                    var n = e[r].semver
                    if (
                      n.major === t.major &&
            ...
            function Y(e, t, r, n) {
              ...
              for (var l = 0; l < t.set.length; ++l) {
                ...
                if (
                  ...
                  f.operator === c || f.operator === u)
                )
                  return !1
                if ((!h.operator || h.operator === c) && o(e, h.semver))
                  return !1
            ...
            ;(r.parse = n),
              ...
              (a.prototype.compare = function(e) {
                return (
                  X('SemVer.compare', this.version, this.loose, e),
            ...
            ;(T.prototype.parse = function(e) {
              ...
              ;(this.operator = r[1]),
                ...
                r[2]
                  ? (this.semver = new a(r[2], this.loose))
                  : (this.semver = Ue)
            }),
              ...
              (T.prototype.test = function(e) {
                return (
                  X('Comparator.test', e, this.loose),
                  this.semver === Ue
                    ? !0
                    : ('string' == typeof e && (e = new a(e, this.loose)),
                      k(e, this.operator, this.semver, this.loose))
                )
              }),
              (r.Range = j),
          ...
          ;(function(t, n) {
            ...
            ;(r.noop = function() {}),
              (r.hash = function(e, t, r) {
                var a = o.createHash(e),
                  s = n.isBuffer(t)
                return (
                  s || 'object' != typeof t || (t = JSON.stringify(i(t))),
              ...
              (r.hmac = function(e, t, r, i) {
                ...
                return (
                  a.update(r, n.isBuffer(r) ? 'binary' : 'utf8'), a.digest(i)
                )
              }),
            ...
            ;(r.getIP = r.getIPv4 = function(e) {
              ...
              (r.getParamNames = function(e, t) {
                if (((t = t !== !1), t && e.__cache_names))
                  return e.__cache_names
                var r = e.toString(),
                  n =
                    r
                      .slice(r.indexOf('(') + 1, r.indexOf(')'))
                      .match(/([^\s,]+)/g) || []
            ...
            var h =
              'function' == typeof setImmediate ? setImmediate : t.nextTick
      ...
      197: [
        function(e, t, r) {
          ...
          function i(e) {
            ...
            if (('object' == typeof e && (e = o(e)), 'string' != typeof e))
        ...
        function(e, t, r) {
          t.exports = {
            ...
            scripts: {
              ...
              'test-cov':
                'istanbul cover node_modules/mocha/bin/_mocha -- -t 30000 -r should -r should-http test/*.test.js',
            ...
            dist: {
              ...
              tarball:
                'http://registry.npm.alibaba-inc.com/urllib/download/urllib-2.8.0.tgz'
            },
          ...
          ;(function(t) {
            ...
            ;(r.hash = function(e, r, o) {
              var a = i.createHash(e),
                s = t.isBuffer(r)
              return (
                s || 'object' != typeof r || (r = JSON.stringify(n(r))),
              ...
              (r.hmac = function o(e, r, n, a) {
                ...
                return (
                  o.update(n, t.isBuffer(n) ? 'binary' : 'utf8'), o.digest(a)
                )
              }),
        ...
        function(e, t, r) {
          ...
          ;(i += o >= 0 ? '+' : '-'),
            ...
            (r.YYYYMMDD = function(e, t) {
              'string' == typeof e
                ? ((t = e), (e = new Date()))
                : ((e = e || new Date()), 'string' != typeof t && (t = '-'))
              var r = e.getDate()
              10 > r && (r = '0' + r)
              var n = e.getMonth() + 1
          ...
          ;(r['try'] = function(e) {
            ...
            (r.dig = function(e) {
              if (e) {
                ...
                for (
                  var t = e[arguments[1]], r = 2;
                  r < arguments.length && t;
                  r++
                )
                  t = t[arguments[r]]
                return t
          ...
          ;(function() {
            ...
            ;(e = new RegExp(/(?!xmlns)^.*:/)),
              ...
              (r.parseNumbers = function(e) {
                return (
                  isNaN(e) ||
                    (e = e % 1 === 0 ? parseInt(e, 10) : parseFloat(e)),
                  e
                )
              }),
                ...
                return (
                  (e.prototype.buildObject = function(e) {
                    ...
                    return (
                      ...
                      this.options.rootName === r.defaults[0.2].rootName
                        ? ((s = Object.keys(e)[0]), (e = e[s]))
                        : (s = this.options.rootName),
                      (o = (function(e) {
                        return function(r, n) {
                          var a, s, c, l, p, h
                          if ('object' != typeof n)
                            e.options.cdata && u(n) ? r.raw(f(n)) : r.txt(n)
                          else
                            for (p in n)
                              if (d.call(n, p))
                                if (((s = n[p]), p === t)) {
                ...
                return (
                  ...
                  (n.prototype.processAsync = function() {
                    ...
                    try {
                      ...
                      if (((t = r), !this.saxParser.errThrown))
                    ...
                    return (
                      ...
                      (this.saxParser.onerror = (function(e) {
                        return function(t) {
                          return (
                            e.saxParser.resume(),
                            e.saxParser.errThrown
                              ? void 0
                              : ((e.saxParser.errThrown = !0),
                                e.emit('error', t))
                          )
                        }
                      })(this)),
                      ...
                      (this.saxParser.onopentag = (function(r) {
                        return function(i) {
                          ...
                          if (((c = {}), (c[t] = ''), !r.options.ignoreAttrs)) {
                            ...
                            for (o in l)
                              d.call(l, o) &&
                                (e in c || r.options.mergeAttrs || (c[e] = {}),
                                ...
                                r.options.mergeAttrs
                                  ? r.assignOrPush(c, u, a)
                                  : (c[e][u] = a))
                          }
                          return (
                            (c['#name'] = r.options.tagNameProcessors
                              ? s(r.options.tagNameProcessors, i.name)
                              : i.name),
                            r.options.xmlns &&
                              (c[r.options.xmlnskey] = {
                                uri: i.uri,
                                local: i.local
                              }),
                            n.push(c)
                        ...
                        return function() {
                          ...
                          if (
                            ...
                            (e.options.explicitChildren &&
                              ...
                              delete f['#name'],
                            f.cdata === !0 && ((r = f.cdata), delete f.cdata),
                            (v = n[n.length - 1]),
                            f[t].match(/^\s*$/) && !r
                              ? ((i = f[t]), delete f[t])
                              : (e.options.trim && (f[t] = f[t].trim()),
                                e.options.normalize &&
                                  (f[t] = f[t].replace(/\s{2,}/g, ' ').trim()),
                                (f[t] = e.options.valueProcessors
                                  ? s(e.options.valueProcessors, f[t])
                                  : f[t]),
                          ...
                          if (
                            e.options.explicitChildren &&
                            !e.options.mergeAttrs &&
                            'object' == typeof f
                          )
                            if (e.options.preserveChildrenOrder) {
                              if (v) {
                                ;(v[e.options.childkey] =
                                  v[e.options.childkey] || []),
                                  (h = {})
                              ...
                              (l = {}),
                                e.options.attrkey in f &&
                                  ((l[e.options.attrkey] =
                                    f[e.options.attrkey]),
                                  delete f[e.options.attrkey]),
                                !e.options.charsAsChildren &&
                                  e.options.charkey in f &&
                                  ((l[e.options.charkey] =
                                    f[e.options.charkey]),
                                  delete f[e.options.charkey]),
                                Object.getOwnPropertyNames(f).length > 0 &&
                                  (l[e.options.childkey] = f),
                                (f = l)
                          return n.length > 0
                            ? e.assignOrPush(v, p, f)
                            ...
                            o
                              ? ((o[t] += r),
                                e.options.explicitChildren &&
                                  ...
                                  e.options.charsAsChildren &&
                                  '' !== r.replace(/\\n/g, '').trim() &&
                                  ((o[e.options.childkey] =
                                    o[e.options.childkey] || []),
                                  (i = { '#name': '__text__' }),
                                  (i[t] = r),
                                  o[e.options.childkey].push(i)),
                                o)
                              : void 0
                          )
                        }
        ...
        function(e, t, r) {
          ;(function(t) {
            !(function(r) {
              function n(e, t) {
                ...
                o(i),
                  ...
                  (i.ENTITIES = i.strictEntities
                    ? Object.create(r.XML_ENTITIES)
                    : Object.create(r.ENTITIES)),
                  (i.attribList = []),
              ...
              function i(e) {
                for (
                  var t = Math.max(r.MAX_BUFFER_LENGTH, 10),
                    n = 0,
                    i = 0,
                    o = A.length;
                  o > i;
              ...
              function y(e) {
                return (
                  e.sawRoot && !e.closedRoot && b(e, 'Unclosed root tag'),
                  e.state !== K.BEGIN &&
                    e.state !== K.BEGIN_WHITESPACE &&
                    e.state !== K.TEXT &&
                    g(e, 'Unexpected end'),
                  m(e),
                  (e.c = ''),
              ...
              function w(e) {
                ...
                if (e.opt.xmlns) {
                  ...
                  if ('xmlns' === r)
                    ...
                    else if ('xmlns' === n && e.attribValue !== B)
                      b(
                        e,
                ...
                if (e.opt.xmlns) {
                  ...
                  for (var o = 0, a = e.attribList.length; a > o; o++) {
                    var s = e.attribList[o],
                      ...
                      f = l.local,
                      h = '' === p ? '' : r.ns[p] || '',
                      m = { name: c, value: u, prefix: p, local: f, uri: h }
                    p &&
                      'xmlns' !== p &&
                      !h &&
                      (b(e, 'Unbound namespace prefix: ' + JSON.stringify(p)),
                      (m.uri = p)),
              ...
              function S(e) {
                ...
                if (0 > t)
                  return (
                    b(e, 'Unmatched closing tag: ' + e.tagName),
              ...
              function k(e) {
                ...
                return e.ENTITIES[r]
                  ...
                  : ((r = n),
                    ...
                    (r = r.replace(/^0+/, '')),
                    i.toLowerCase() !== r
                      ? (b(e, 'Invalid character entity'), '&' + e.entity + ';')
                      : String.fromCodePoint(t))
              }
              function T(e, t) {
                '<' === t
                  ? ((e.state = K.OPEN_WAKA), (e.startTagPosition = e.position))
                  : f(N, t) &&
                    (b(e, 'Non-whitespace before first tag.'),
                    (e.textNode = t),
                    (e.state = K.TEXT))
              }
              function j(e, t) {
              ...
              function O(e) {
                ...
                for (var r = 0, n = ''; ; ) {
                  ...
                  switch (
                    ...
                    case K.BEGIN:
                      if (((t.state = K.BEGIN_WHITESPACE), '\ufeff' === n))
                        continue
                      T(t, n)
                      continue
                    ...
                    case K.TEXT:
                      ...
                      '<' !== n || (t.sawRoot && t.closedRoot && !t.strict)
                        ? (!f(N, n) ||
                            (t.sawRoot && !t.closedRoot) ||
                            b(t, 'Text data outside of root node.'),
                          '&' === n
                            ? (t.state = K.TEXT_ENTITY)
                            : (t.textNode += n))
                        : ((t.state = K.OPEN_WAKA),
                    ...
                    case K.SGML_DECL:
                      ;(t.sgmlDecl + n).toUpperCase() === q
                        ...
                        ? ((t.state = K.COMMENT),
                          (t.comment = ''),
                          (t.sgmlDecl = ''))
                        : (t.sgmlDecl + n).toUpperCase() === U
                        ? ((t.state = K.DOCTYPE),
                          (t.doctype || t.sawRoot) &&
                            b(t, 'Inappropriately located doctype declaration'),
                          (t.doctype = ''),
                          (t.sgmlDecl = ''))
                        : '>' === n
                        ? (d(t, 'onsgmldeclaration', t.sgmlDecl),
                          ...
                          (t.state = K.TEXT))
                        : p(M, n)
                        ? ((t.state = K.SGML_DECL_QUOTED), (t.sgmlDecl += n))
                        : (t.sgmlDecl += n)
                      continue
                    ...
                    case K.DOCTYPE:
                      '>' === n
                        ...
                        : ((t.doctype += n),
                          '[' === n
                            ? (t.state = K.DOCTYPE_DTD)
                            : p(M, n) &&
                              ((t.state = K.DOCTYPE_QUOTED), (t.q = n)))
                      continue
                    ...
                    case K.DOCTYPE_DTD:
                      ;(t.doctype += n),
                        ']' === n
                          ? (t.state = K.DOCTYPE)
                          : p(M, n) &&
                            ((t.state = K.DOCTYPE_DTD_QUOTED), (t.q = n))
                      continue
                    ...
                    case K.COMMENT:
                      '-' === n
                        ? (t.state = K.COMMENT_ENDING)
                        : (t.comment += n)
                      continue
                    case K.COMMENT_ENDING:
                      '-' === n
                        ? ((t.state = K.COMMENT_ENDED),
                          (t.comment = v(t.opt, t.comment)),
                          t.comment && d(t, 'oncomment', t.comment),
                          (t.comment = ''))
                        : ((t.comment += '-' + n), (t.state = K.COMMENT))
                      continue
                    case K.COMMENT_ENDED:
                      '>' !== n
                        ? (b(t, 'Malformed comment'),
                          (t.comment += '--' + n),
                          (t.state = K.COMMENT))
                        : (t.state = K.TEXT)
                      continue
                    ...
                    case K.CDATA_ENDING:
                      ']' === n
                        ? (t.state = K.CDATA_ENDING_2)
                        : ((t.cdata += ']' + n), (t.state = K.CDATA))
                      continue
                    ...
                    case K.PROC_INST:
                      '?' === n
                        ? (t.state = K.PROC_INST_ENDING)
                        : p(N, n)
                        ? (t.state = K.PROC_INST_BODY)
                        : (t.procInstName += n)
                      continue
                      ...
                      p(H, n)
                        ...
                        : (_(t),
                          '>' === n
                            ...
                            : (f(N, n) && b(t, 'Invalid character in tag name'),
                              (t.state = K.ATTRIB)))
                      continue
                      ...
                      if ('=' === n) t.state = K.ATTRIB_VALUE
                        ...
                        b(t, 'Attribute without value'),
                          ...
                          '>' === n
                            ? E(t)
                            : p(z, n)
                            ? ((t.attribName = n), (t.state = K.ATTRIB_NAME))
                            : (b(t, 'Invalid attribute name'),
                              (t.state = K.ATTRIB))
                      }
                      continue
                    case K.ATTRIB_VALUE:
                      if (p(N, n)) continue
                      p(M, n)
                        ? ((t.q = n), (t.state = K.ATTRIB_VALUE_QUOTED))
                        : (b(t, 'Unquoted attribute value'),
                          (t.state = K.ATTRIB_VALUE_UNQUOTED),
                          (t.attribValue = n))
                      continue
                    case K.ATTRIB_VALUE_QUOTED:
                      if (n !== t.q) {
                        '&' === n
                          ? (t.state = K.ATTRIB_VALUE_ENTITY_Q)
                          : (t.attribValue += n)
                        continue
                      }
                    ...
                    case K.ATTRIB_VALUE_CLOSED:
                      p(N, n)
                        ...
                        ? (t.state = K.OPEN_TAG_SLASH)
                        : p(z, n)
                        ? (b(t, 'No whitespace between attributes'),
                          (t.attribName = n),
                          (t.attribValue = ''),
                          (t.state = K.ATTRIB_NAME))
                        : b(t, 'Invalid attribute name')
                    ...
                    case K.ATTRIB_VALUE_UNQUOTED:
                      if (f(L, n)) {
                        '&' === n
                          ? (t.state = K.ATTRIB_VALUE_ENTITY_U)
                          : (t.attribValue += n)
                        continue
                      }
                      ...
                      if (t.tagName)
                        '>' === n
                          ...
                          ? ((t.script += '</' + t.tagName),
                            (t.tagName = ''),
                            (t.state = K.SCRIPT))
                          : (f(N, n) && b(t, 'Invalid tagname in closing tag'),
                            (t.state = K.CLOSE_TAG_SAW_WHITE))
                      else {
                        if (p(N, n)) continue
                        f(z, n)
                          ? t.script
                            ? ((t.script += '</' + n), (t.state = K.SCRIPT))
                            : b(t, 'Invalid tagname in closing tag.')
                          : (t.tagName = n)
                      }
                      continue
                    case K.CLOSE_TAG_SAW_WHITE:
                      ...
                      '>' === n
                        ? S(t)
                        : b(t, 'Invalid characters in closing tag')
                      continue
                    case K.TEXT_ENTITY:
                    ...
                    case K.ATTRIB_VALUE_ENTITY_U:
                      ...
                      ';' === n
                        ? ((t[c] += k(t)), (t.entity = ''), (t.state = s))
                        : p(t.entity.length ? X : Y, n)
                        ? (t.entity += n)
                        : (b(t, 'Invalid character in entity name'),
                          (t[c] += '&' + t.entity + n),
                          (t.entity = ''),
                          (t.state = s))
                      continue
          ...
          ;(function() {
            ...
            ;(n = e('lodash/create')),
              (t.exports = r = (function() {
                function e(e, t, r) {
                  if (((this.stringify = e.stringify), null == t))
                    throw new Error(
                      'Missing attribute name of element ' + e.name
                    )
                  if (null == r)
                    throw new Error(
              ...
              (t.exports = r = (function() {
                function e(e, t) {
                  ...
                  null == t && (t = {}),
                    ...
                    t.headless ||
                      (r.declaration(t),
                      (null == t.pubID && null == t.sysID) || r.doctype(t))
                }
                return (
                  ...
                  (e.prototype.toString = function(e) {
                    var t, r, n, i, o, a, s, c
                    return (
                      (i = (null != e ? e.pretty : void 0) || !1),
                      (t =
                        null != (a = null != e ? e.indent : void 0) ? a : '  '),
                      (n = null != (s = null != e ? e.offset : void 0) ? s : 0),
                      (r =
                        null != (c = null != e ? e.newline : void 0)
                          ? c
                          : '\n'),
                      (o = ''),
          ...
          ;(function() {
            ...
            ;(i = e('lodash/create')),
              ...
              (t.exports = r = (function(e) {
                function t(e, r) {
                  if ((t.__super__.constructor.call(this, e), null == r))
                ...
                return (
                  ...
                  (t.prototype.toString = function(e, t) {
                    ...
                    return (
                      (o = (null != e ? e.pretty : void 0) || !1),
                      (r =
                        null != (s = null != e ? e.indent : void 0) ? s : '  '),
                      (i = null != (c = null != e ? e.offset : void 0) ? c : 0),
                      (n =
                        null != (u = null != e ? e.newline : void 0)
                          ? u
                          : '\n'),
                      t || (t = 0),
            ...
            ;(n = e('lodash/create')),
              (t.exports = r = (function() {
                function e(e, t, r, n, i, o) {
                  ...
                  if (
                    (0 !== i.indexOf('#') && (i = '#' + i),
                    !i.match(/^(#REQUIRED|#IMPLIED|#FIXED|#DEFAULT)$/))
                  )
                    throw new Error(
        ...
        function(e, t, r) {
          ;(function() {
            ...
            ;(n = e('lodash/create')),
              ...
              (t.exports = r = (function() {
                function e(e, t, r, n) {
                  if (((this.stringify = e.stringify), null == r))
                  ...
                  if (
                    ...
                    if (
                      ...
                      null != n.nData &&
                        (this.nData = this.stringify.dtdNData(n.nData)),
                      this.pe && this.nData)
                    )
                      throw new Error(
                  ...
                  (e.prototype.toString = function(e, t) {
                    ...
                    return (
                      ...
                      this.pubID && this.sysID
                        ...
                        : this.pubID
                        ? (a += ' PUBLIC "' + this.pubID + '"')
                        : this.sysID && (a += ' SYSTEM "' + this.sysID + '"'),
                      (a += '>'),
                      o && (a += n),
                      a
                    )
              ...
              (t.exports = r = (function(e) {
                function t(e, r, n, i) {
                  ...
                  t.__super__.constructor.call(this, e),
                    ...
                    null != n &&
                      (this.encoding = this.stringify.xmlEncoding(n)),
                    null != i &&
          ...
          ;(function() {
            ...
            ;(l = e('lodash/create')),
              ...
              (t.exports = c = (function() {
                ...
                return (
                  (e.prototype.element = function(e, t) {
                    var r
                  ...
                  (e.prototype.entity = function(e, t) {
                    var r
                    return (
                      (r = new a(this, !1, e, t)), this.children.push(r), this
                    )
                  }),
                  (e.prototype.pEntity = function(e, t) {
                    var r
                    return (
                      (r = new a(this, !0, e, t)), this.children.push(r), this
                    )
                  }),
                  ...
                  (e.prototype.toString = function(e, t) {
                    ...
                    if (
                      ((c = (null != e ? e.pretty : void 0) || !1),
                      (i =
                        null != (l = null != e ? e.indent : void 0) ? l : '  '),
                      (s = null != (p = null != e ? e.offset : void 0) ? p : 0),
                      (a =
                        null != (f = null != e ? e.newline : void 0)
                          ? f
                          : '\n'),
                      t || (t = 0),
                      (d = new Array(t + s + 1).join(i)),
                      (u = ''),
                      c && (u += d),
                      (u += '<!DOCTYPE ' + this.root().name),
                      this.pubID && this.sysID
                        ? (u +=
                            ' PUBLIC "' + this.pubID + '" "' + this.sysID + '"')
                        : this.sysID && (u += ' SYSTEM "' + this.sysID + '"'),
                ...
                return (
                  ...
                  (t.prototype.clone = function() {
                    ...
                    return (
                      ...
                      this.children.forEach(function(e) {
                        var t
                        return (
                          (t = e.clone()), (t.parent = n), n.children.push(t)
                        )
                      }),
                      n
                    )
                  ...
                  (t.prototype.attribute = function(e, t) {
                    ...
                    if ((null != e && (e = e.valueOf()), u(e)))
                      ...
                      c(t) && (t = t.apply()),
                        (this.options.skipNullAttributes && null == t) ||
                          (this.attributes[e] = new r(this, e, t))
                    return this
                  }),
                  ...
                  (t.prototype.toString = function(e, t) {
                    var r,
                      ...
                      E
                    for (
                      m = (null != e ? e.pretty : void 0) || !1,
                        o =
                          null != (g = null != e ? e.indent : void 0)
                            ? g
                            : '  ',
                        d = null != (y = null != e ? e.offset : void 0) ? y : 0,
                        h =
                          null != (b = null != e ? e.newline : void 0)
                            ? b
                            : '\n',
                        t || (t = 0),
                        E = new Array(t + d + 1).join(o),
                        v = '',
                        _ = this.instructions,
                        i = 0,
                        u = _.length;
          ...
          ;(function() {
            ...
            ;(f = e('lodash/isObject')),
              ...
              (t.exports = s = (function() {
                ...
                return (
                  (t.prototype.element = function(e, t, r) {
                    var n, i, o, a, s, c, u, d, m, v
                    if (
                      ((c = null),
                      null == t && (t = {}),
                      (t = t.valueOf()),
                      f(t) || ((m = [t, r]), (r = m[0]), (t = m[1])),
                      null != e && (e = e.valueOf()),
                      Array.isArray(e))
                    )
                      for (o = 0, u = e.length; u > o; o++)
                      ...
                      for (s in e)
                        if (h.call(e, s))
                          if (
                            ...
                            0 === s.indexOf(this.stringify.convertPIKey)
                          )
                            c = this.instruction(
                              s.substr(this.stringify.convertPIKey.length),
                              v
                            )
                          else if (
                    ...
                    if (null == c)
                      throw new Error(
                        'Could not create any elements with: ' + e
                      )
                    return c
                  }),
            ...
            t.exports = e = (function() {
              function e(e) {
                ...
                ;(this.allowSurrogateChars =
                  null != e ? e.allowSurrogateChars : void 0),
                  (this.noDoubleEncoding =
                    null != e ? e.noDoubleEncoding : void 0),
                  (i = (null != e ? e.stringify : void 0) || {})
                for (t in i) n.call(i, t) && ((o = i[t]), (this[t] = o))
              }
              return (
                (e.prototype.eleName = function(e) {
                  return (e = '' + e || ''), this.assertLegalChar(e)
                }),
                (e.prototype.eleText = function(e) {
                  return (
                    (e = '' + e || ''), this.assertLegalChar(this.elEscape(e))
                  )
                }),
                (e.prototype.cdata = function(e) {
                  if (((e = '' + e || ''), e.match(/]]>/)))
                    throw new Error('Invalid CDATA text: ' + e)
                  return this.assertLegalChar(e)
                }),
                (e.prototype.comment = function(e) {
                  if (((e = '' + e || ''), e.match(/--/)))
                    throw new Error(
                      'Comment text cannot contain double-hypen: ' + e
                    )
                  return this.assertLegalChar(e)
                }),
                ...
                (e.prototype.insValue = function(e) {
                  if (((e = '' + e || ''), e.match(/\?>/)))
                    throw new Error(
                      'Invalid processing instruction value: ' + e
                    )
                  return e
                }),
                (e.prototype.xmlVersion = function(e) {
                  if (((e = '' + e || ''), !e.match(/1\.[0-9]+/)))
      ...
      262: [
        function(e, t, r) {
          function n(e, t) {
            return (
              a.call(e, t) || ('object' == typeof e && t in e && null === i(e))
            )
          }
          ...
          function n(e) {
            return o(function(t, r) {
              var n = -1,
                ...
                s = o > 2 ? r[2] : void 0
              for (
                a = 'function' == typeof a ? (o--, a) : void 0,
                  s && i(r[0], r[1], s) && ((a = 3 > o ? void 0 : a), (o = 1)),
                  t = Object(t);
                ++n < o;
          ...
          function n(e, t, r, n, i, w, S) {
            switch (r) {
              ...
              case g:
                ...
                return j
                  ? j == t
                  : ((w |= u), S.set(e, t), a(k(e), k(t), n, i, w, S))
              case b:
      ...
      296: [
        function(e, t, r) {
          function n(e, t) {
            return (
              (e = 'number' == typeof e || o.test(e) ? +e : -1),
              (t = null == t ? i : t),
              e > -1 && e % 1 == 0 && t > e
            )
          }
      ...
      303: [
        function(e, t, r) {
          function n(e) {
            var t = this.__data__
            return s(e)
              ? a('string' == typeof e ? t.string : t.hash, e)
              : i
              ? t.map['delete'](e)
              : o(t.map, e)
          }
      ...
      306: [
        function(e, t, r) {
          function n(e, t) {
            ...
            return (
              s(e)
                ? a('string' == typeof e ? r.string : r.hash, e, t)
                : i
                ? r.map.set(e, t)
                : o(r.map, e, t),
              this
        ...
        function(e, t, r) {
          var n = e('./memoize'),
            ...
            s = n(function(e) {
              var t = []
              return (
                i(e).replace(o, function(e, r, n, i) {
      ...
      332: [
        function(e, t, r) {
          function n(e) {
            if (s(e) && (a(e) || p(e) || u(e.splice) || o(e) || c(e)))
              return !e.length
            if (l(e)) {
              var t = i(e)
      ...
      340: [
        function(e, t, r) {
          ...
          ;(I[x] = I[w] = I[E] = I[S] = I[k] = I[T] = I[j] = I[O] = I[A] = !0),
            (I[a] = I[s] = I[b] = I[c] = I[_] = I[u] = I[l] = I[p] = I[f] = I[
              h
            ] = I[d] = I[m] = I[v] = I[g] = I[y] = !1)
        ...
        function(e, t, r) {
          t.exports = {
            ...
            scripts: {
              ...
              'test-cov':
                'istanbul cover node_modules/.bin/_mocha -- -R dot -t 60000 -r thunk-mocha -r should test/*.test.js',
              jshint: 'jshint .',
              autod: 'autod',
              'build-dist':
                'node browser-build.js > dist/aliyun-oss-sdk.js && MINIFY=1 node browser-build.js > dist/aliyun-oss-sdk.min.js',
